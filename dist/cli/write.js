...
async function reinit() {
  ...
  await fs3.mkdir(path3.join(os3.homedir(), ".hawk"), { recursive: true });
  await fs3.writeFile(backupPath, JSON.stringify({ memories, exportedAt: (/* @__PURE__ */ new Date()).toISOString() }, null, 2));
