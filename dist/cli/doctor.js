...
var init_constants = __esm({
  "src/constants.ts"() {
    ...
    MIN_RECALL_SCORE = parseFloat(process.env.HAWK_MIN_RECALL_SCORE || "0.55");
    INFERENCE_RELIABILITY = parseFloat(process.env.HAWK_INFERENCE_RELIABILITY || "0.3");
    INFERENCE_RECALL_PENALTY = parseFloat(process.env.HAWK_INFERENCE_RECALL_PENALTY || "0.7");
    UNVERIFIED_LEARNINGS_RELIABILITY = parseFloat(process.env.HAWK_UNVERIFIED_LEARNINGS_RELIABILITY || "0.3");
    LEARNINGS_VERIFY_BOOST = parseFloat(process.env.HAWK_LEARNINGS_VERIFY_BOOST || "0.2");
    CORRECTION_BOOST = parseFloat(process.env.HAWK_CORRECTION_BOOST || "0.1");
