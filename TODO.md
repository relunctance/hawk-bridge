...
| # | 功能项 | 优先级 |
|---|--------|--------|
| 1 | [1. 记忆 Taxonomy 扩展](#item-1) | 🔴 |
| 2 | [2. What NOT to Save 明确排除列表](#item-2) | 🔴 |
| 3 | [3. Memory Fence 标签机制](#item-3) | 🔴 |
| 4 | [4. 记忆年龄标签（Freshness Text）](#item-4) | 🟡 |
| 5 | [5. Source Tracing](#item-5) | 🟡 |
| 6 | [6. Team Memory + Symlink 安全](#item-6) | 🟡 |
| 7 | [7. Recent Tools-Aware 记忆选择](#item-7) | 🟡 |
| 8 | [8. 双重选择器](#item-8) | 🟡 |
| 9 | [9. Ignore Memory 指令支持](#item-9) | 🟡 |
| 10 | [10. 相对日期转绝对日期](#item-10) | 🟡 |
| 11 | [11. Memory Shape Telemetry](#item-11) | 🟢 |
| 12 | [12. MEMORY.md 入口索引](#item-12) | 🟢 |
| 13 | [13. Context Fence（防注入包装）](#item-13) | 🔴 |
| 14 | [14. 记忆内容安全扫描](#item-14) | 🔴 |
| 15 | [15. 记忆字符限额 + 分隔符](#item-15) | 🟡 |
| 16 | [16. Hook 系统完善](#item-16) | 🔴 |
| 17 | [17. 子 Agent 上下文注入 API](#item-17) | 🔴 |
| 18 | [18. Learnings 记忆分类](#item-18) | 🟡 |
| 19 | [19. Task History 记忆](#item-19) | 🟡 |
| 20 | [20. Effect Evaluation 记忆](#item-20) | 🟡 |
| 21 | [21. Cron Job 结果自动写入记忆](#item-21) | 🟡 |
| 22 | [22. Multi-Agent Session Isolation](#item-22) | 🔴 |
| 23 | [23. Qujin-Constitution 锚定记忆](#item-23) | 🟡 |
| 24 | [24. Confidence-Gated Recall](#item-24) | 🟡 |
| 25 | [25. LLM Self-Verification Hook](#item-25) | 🟡 |
| 26 | [26. Factuality Classification](#item-26) | 🟡 |
| 27 | [27. Audit Log（写入审计）](#item-27) | 🔴 |
| 28 | [28. Injection Detector（注入检测）](#item-28) | 🔴 |
| 29 | [29. Write Confidence Threshold](#item-29) | 🟡 |
| 30 | [30. Drift Detector（漂移检测）](#item-30) | 🟡 |
| 31 | [31. Quarantine Mechanism（隔离机制）](#item-31) | 🟡 |
| 32 | [32. Consistency Check（一致性巡检）](#item-32) | 🟡 |
| 33 | [33. Session Fencing（会话边界隔离）](#item-33) | 🟡 |
| 34 | [34. Cross-Reference Verification](#item-34) | 🟡 |
| 35 | [35. Background Prefetch（异步预取）](#item-35) | 🟡 |
| 36 | [36. Session Insights（会话洞察）](#item-36) | 🟡 |
| 37 | [37. MemoryManager 编排层](#item-37) | 🟡 |
| 38 | [38. Skill Auto-Creation（技能自动创建）](#item-38) | 🟡 |
| 39 | [39. Multi-tenant Namespace（多租户隔离）](#item-39) | 🔴 |
| 40 | [40. Auto-Compression（自动记忆压缩）](#item-40) | 🟡 |
| 41 | [41. User Modeling（结构化用户画像）](#item-41) | 🟡 |
| 42 | [42. Skills Hub 兼容层](#item-42) | 🟢 |
| 43 | [43. 增强的 Health Alerting（健康告警分级）](#item-43) | 🟢 |
| 44 | [44. 记忆验证引擎](#item-44) | 🟡 |
| 45 | [45. 知识图谱关系层](#item-45) | 🟢 |
| 46 | [46. 主动记忆推送（Proactive Memory）](#item-46) | 🟢 |
| 47 | [47. Embedding Provider 抽象层](#item-47) | 🟡 |
| 48 | [48. VectorStore Provider 抽象层](#item-48) | 🟡 |
| 49 | [49. 多语言 SDK（TypeScript + Go）](#item-49) | 🟢 |
| 50 | [50. 多租户 Storage Quota + Rate Limit](#item-50) | 🔴 |
| 51 | [51. 跨设备 Sync 同步协议](#item-51) | 🟡 |
| 52 | [52. 记忆加密层 + Right-to-Erasure](#item-52) | 🔴 |
| 53 | [53. 商业化基础设施](#item-53) | 🟢 |
| 54 | [54. Event vs Concept 区分](#item-54) | 🟢 |
| 55 | [55. 记忆版本历史链（Version History）](#item-55) | 🟡 |
| 56 | [56. 记忆质量反馈闭环](#item-56) | 🟡 |
| 57 | [57. Memory ROI 量化评估体系](#item-57) | 🟡 |
| 58 | [58. 元认知自我调优（Meta-Cognition Tuning）](#item-58) | 🟢 |
| 59 | [59. Multi-Agent 视角感知记忆](#item-59) | 🟡 |
| 60 | [60. 规则引擎核心（Rule Engine Core）](#item-60) | 🔴 |
| 61 | [61. Capture 写入规则（Capture Rules）](#item-61) | 🔴 |
| 62 | [62. Recall 召回规则（Recall Rules）](#item-62) | 🟡 |
| 63 | [63. Decay 衰减规则（Decay Rules）](#item-63) | 🟡 |
| 64 | [64. Lifecycle 生命周期规则](#item-64) | 🟡 |
| 65 | [65. Verify 验证触发规则](#item-65) | 🟡 |
| 66 | [66. Tier 升降规则](#item-66) | 🟢 |
| 67 | [67. 规则引擎 API + 管理界面](#item-67) | 🟡 |
| 68 | [68. Auto-Generated 规则（自动生成规则）](#item-68) | 🟢 |
| 69 | [69. 垃圾记忆清理机制](#item-69) | 🟡 |
| 70 | [70. 主动遗忘机制（Active Forgetting）](#item-70) | 🟢 |
| 71 | [71. Capture 拒绝机制](#item-71) | 🟡 |
| 72 | [72. 任务完成度 Ranking](#item-72) | 🟡 |
| 73 | [73. 多 Agent 可见性控制](#item-73) | 🔴 |
| 74 | [74. 自我监控（hawk-bridge 对自己质量是盲的）](#item-74) | 🟢 |

---

## 🔴 Claude Code 源码对比 {#claude-code-源码对比}
